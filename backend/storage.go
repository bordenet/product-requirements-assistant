...
func getDefaultPrompt(phase string) string {
	switch phase {
	case "claude_initial":
		return `You are a principal Product Manager for a <NATURE OF BUSINESS HERE -- backend/storage.go> company. You will help me build a product requirements document (PRD) for our engineering team to consume.
